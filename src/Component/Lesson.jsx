...
export default function Lesson() {
    ...
    useEffect(() => {
        axios.get(`https://online-platform-backend-1.onrender.com/lesson/get/?courseId=${courseId}`)
            .then((res) => {
                setLessons(res.data);
                setLoading(false);
            })
    ...
    return (
        <div className="lesson-container">
            ...
            {loading ? (
                <p className="text-center text-white">Loading lessons...</p>
            ) : (
                <div className="lesson-grid">
                    {lessons.map((lesson, index) => (
                        <div key={index} className="lesson-card">
                            ...
                            {lesson.notes && (
                                <a href={lesson.notes} className="lesson-notes" target="_blank" rel="noopener noreferrer">
                                    📄 View Notes
                                </a>
                            )}
                        </div>
